          ...
          <li v-for="(everyGoods,index2) in goods1.goodsDetail" :key="index2">
            ...
            <div class="goodsDetail">
              ...
              <div class="goodsPrice">
                ...
                <button @click="--everyGoods.num" :disabled="everyGoods.num===0">-</button>
                {{everyGoods.num}}
                <button @click="++everyGoods.num">+</button>
              </div>
            </div>
          </li>
        </ul>
    ...
    computed: {
      totalPrice: function () {
        ...
        for (var i = 0, len = this.goodsList.length; i < len; i++) {
          for (var j = 0, len1 = this.goodsList[i].goodsDetail.length; j < len1; j++) {
            total += this.goodsList[i].goodsDetail[j].num * this.goodsList[i].goodsDetail[j].price
          }
        }
